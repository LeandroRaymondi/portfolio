...
const Contact = () => {
  ...
  return (
    <section className="contact section" id="contact">
      <h2 className="section__title">Entrar en contacto</h2>
      <span className="section__subtitle">Contacto</span>
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+541168489990</span>

              <a
                href="https://api.whatsapp.com/send?phone=541168489990&text=Hello, more information!"
                className="contact__button"
              >
                Escríbeme{" "}
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
          ...
          <form ref={form} onSubmit={sendEmail} className="contact__form">
            ...
            <div className="contact__form-div contact__form-area">
              ...
              <textarea
                ...
                rows="10"
                className="contact__form-input"
                placeholder="Escríbeme sobre tu proyecto"
              ></textarea>
            </div>
